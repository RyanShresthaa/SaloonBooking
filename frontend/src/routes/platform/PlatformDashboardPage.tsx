...
import PlatformCatalogAdminPanel from '@/routes/platform/PlatformCatalogAdminPanel';
      ...
      <div className="page-shell-spacious">
        ...
        <section className="mt-10">
          <Link
            ...
            spellCheck={false}
            className="surface-card inline-block rounded-lg p-5 text-sm font-medium text-rose-900 underline decoration-rose-400/80 hover:text-rose-950 dark:text-rose-200"
          >
            Moderate marketplace listings (approve / reject / featured)
          </Link>
        </section>

        <PlatformCatalogAdminPanel />
      </div>
    </AuthGuard>
  );
}
